...
export function MainList({path, meta, things, values, funcThings, funcDelete } : parameters) {
                ...
                <div style={{height: "180px", width:"65%", display: "inline-block", verticalAlign: "top"}}>
                    <Card 
                        ...
                        <Card.SecondaryActions>
                            ...
                            <IconButton key="delete" name="trash-alt" tooltip="Delete" onClick={(e) => funcDelete(e, item.thingId)}/>
                        </Card.SecondaryActions>
                    </Card>
                </div>
            </div>
