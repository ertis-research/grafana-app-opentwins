...
export function ListMainObject(props:any) {
    ...
    const mainObjects = [
        {id: 1, name: 'Raspberry', description: 'Dispositivo raspberry pi compuesto de un sensor DHT22', image: 'https://hardzone.es/app/uploads-hardzone.es/2020/06/Proyectos-Raspberry-Pi.jpg'},
